...
package com.bytenine.tinnitusrelief.service.players;

import static com.bytenine.tinnitusrelief.ui.MainActivity.pauseIsPressed;
...
import com.bytenine.tinnitusrelief.service.PlaybackInfoListener;
...
import com.bytenine.tinnitusrelief.ui.MainActivity;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    private int mState;
    public static boolean mCurrentMediaPlayedToCompletion;
    ...
    private void setNewState(@PlaybackStateCompat.State int newPlayerState) {
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED && !pauseIsPressed) {
            mCurrentMediaPlayedToCompletion = true;
        }
    ...
    public void seekTo(long position) {
        if (mMediaPlayer != null) {
            ...
            Log.e("seekbar","seekTo: " + mSeekWhileNotPlaying);
