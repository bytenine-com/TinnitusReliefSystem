...
public abstract class PlayerAdapter {
    ...
    public PlayerAdapter(@NonNull Context context) {
        ...
        SharedPreferences preferences = mApplicationContext.getSharedPreferences("TRS", MODE_PRIVATE);
        preferences.edit().putBoolean("pausePressed",false).apply();
    ...
    public final void play() {
        if (mAudioFocusHelper.requestAudioFocus()) {
            ...
            Log.e("seekbar", "Playeradapter - Play -- false" );
            onPlay();
        }
    }
    ...
    public final void pause() {
        ...
        SharedPreferences preferences = mApplicationContext.getSharedPreferences("TRS", MODE_PRIVATE);
        preferences.edit().putBoolean("pausePressed",true).apply();
        pauseIsPressed = true;
        Log.e("seekbar", "Playeradapter - Pause -- true" );
    ...
    public final void stop() {
        ...
        preferences.edit().putBoolean("pausePressed",true).apply();
        pauseIsPressed = false;
        Log.e("seekbar", "Playeradapter - Stop -- true" );
        onStop();
    }
