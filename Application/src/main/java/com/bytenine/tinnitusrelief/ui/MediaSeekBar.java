...
public class MediaSeekBar extends AppCompatSeekBar {
    ...
    public PlaybackStateCompat savedState;
    ...
    public OnSeekBarChangeListener mOnSeekBarChangeListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
           ...
           // Log.e("seekbar","OnSeekBarChangeListener onProgressChanged: " + progress);
    ...
    private class ControllerCallback
        ...
        public void onPlaybackStateChanged(PlaybackStateCompat state) {
            ...
            if(savedState != null) {
                savedState = state;
                Log.e("seekbar", "savedstate not null");
            }
            ...
            Log.e("seekbar","Seekbar onPlaybackStateChanged, progress: " + progress);
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            ...
            Log.e("seekbar","onMetadataChanged, progress: " + seekBarProgress + " Duration: " + metadata.getLong(MediaMetadataCompat.METADATA_KEY_DURATION));
            final int max = metadata != null
                    ? (int) metadata.getLong(MediaMetadataCompat.METADATA_KEY_DURATION)
                    : 0;

        //    if (seekBarProgress <= 0) {
                Log.e("seekbar","onMetadataChanged, setProgress, set max");
                setProgress(0);
                setMax(max);
        //    }
         //   else {
                Log.e("seekbar","onMetadataChanged, call onPlaybackStateChanged");
             //   onPlaybackStateChanged(savedState);
       //     }
        ...
        public void onAnimationUpdate(final ValueAnimator valueAnimator) {
          ...
          //  Log.e("seekbar","onAnimationUpdate, msIsTracking: " + mIsTracking);
